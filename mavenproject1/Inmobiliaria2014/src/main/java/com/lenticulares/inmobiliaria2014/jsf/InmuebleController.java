...
import com.lenticulares.inmobiliaria2014.bean.InmuebleFacade;
...
public class InmuebleController implements Serializable {
    ...
    @EJB
    private com.lenticulares.inmobiliaria2014.bean.InmuebleFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Inmueble) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("InmuebleCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("InmuebleUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("InmuebleDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Inmueble getInmueble(java.lang.Integer id) {
